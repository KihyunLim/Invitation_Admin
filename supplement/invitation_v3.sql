...
ALTER TABLE ADMIN ADD COLUMN (ENABLED BOOLEAN NOT NULL);
UPDATE ADMIN SET ENABLED = TRUE;
...
CREATE TABLE MAIN_INFO (
	...
	, NAME_GROOM VARCHAR(30) NOT NULL
	, NAME_BRIDE VARCHAR(30) NOT NULL
	, CONTENT_GROOM VARCHAR(1000)
	, CONTENT_BRIDE VARCHAR(1000)
	, SEQ_IMG_MAIN INT
...
WHERE
	1=1
--	AND IL.ID = 'test2'
	AND (SELECT NAME FROM USERES U WHERE U.ID = IL.ID) = '고객2'
--	AND (SELECT DATE_WEDDING FROM MAIN_INFO MI WHERE MI.INV_SEQ = IL.SEQ) >= '20200719'
--	AND (SELECT DATE_WEDDING FROM MAIN_INFO MI WHERE MI.INV_SEQ = IL.SEQ) <= '20200727'
ORDER BY
	IL.SEQ DESC
 LIMIT 0, 5
;
SELECT CONVERT('20200610', INTEGER) < CONVERT('20200719', INTEGER);
