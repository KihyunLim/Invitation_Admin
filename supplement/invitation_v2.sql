...
SELECT
	...
	, (SELECT DATE_WEDDING FROM MAIN_INFO MI WHERE MI.INV_SEQ=IL.SEQ) AS weddigDate
FROM
	INVITATION_LIST IL
WHERE
	1=1
--	AND IL.ID = 'test2'
--	AND NAME = '고객2'
--	AND IL.DATE_BEGIN >= 20200610
--	AND IL.DATE_END <= 20200731
;
SELECT CONVERT('20200610', INTEGER);
